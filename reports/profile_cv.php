...
$pdf->Cell(-120,0,ProfileStr($profile['FIRST_NAME'].' '.$profile['LAST_NAME'],0,1, 'R'));
$pdf->Ln(7); 
...
$pdf->Cell(-120,0,ProfileStr($profile, 'EMAIL'),0,1, 'R');
$pdf->Ln(7);  
$pdf->SetFont('Arial','',12);     
$pdf->Cell(0,0,'Contact No. : ',0,1);
$pdf->Cell(-120,0,ProfileStr($profile, 'PHONE'),0,1, 'R');
$pdf->Ln(7);  
$pdf->SetFont('Arial','',12);     
$pdf->Cell(0,0,'Civil Status: ',0,1);
$pdf->Cell(-120,0,ProfileStr($profile, 'CIVIL_STATUS'),0,1, 'R');
$pdf->Ln(7);  
$pdf->SetFont('Arial','',12);     
$pdf->Cell(0,0,'Sex: ',0,1);
$pdf->Cell(-120,0,ProfileStr($profile, 'SEX'),0,1, 'R');
$pdf->Ln(7); 
$pdf->SetFont('Arial','',12);     
$pdf->Cell(0,0,'Birthday: ',0,1);
$pdf->Cell(-120,0,ProfileStr($profile, 'BIRTHDAY'),0,1, 'R');
$pdf->Ln(10); 
...
$pdf->Cell(-120,0,ProfileStr($profile, 'COURSE_NAME'),0,1, 'R');
$pdf->Ln(7); 
$pdf->SetFont('Arial','',12);      
$pdf->Cell(0,0,'Year Graduated: ',0,1);
$pdf->Cell(-120,0,ProfileStr($profile, 'BATCH'),0,1, 'R');
$pdf->Ln(7);  
$pdf->SetFont('Arial','',12);     
...
$pdf->Cell(-120,0,ProfileStr($profile, 'ADVANCE_STUDY_PASSED'),0,1, 'R');
$pdf->Ln(10);
...
$pdf->Cell(-120,0,ProfileStr($profile, 'EMPLOYMENT_STATUS'),0,1, 'R');
$pdf->Ln(7); 
$pdf->SetFont('Arial','',12);     
$pdf->Cell(0,0,'Number of Job experiences: ',0,1);
$pdf->Cell(-120,0,ProfileStr($profile, 'JOB_EXPERIENCES'),0,1, 'R');
$pdf->Ln(7); 
$pdf->SetFont('Arial','',12);    
$pdf->Cell(0,0,'Place of work: ',0,1);
$pdf->Cell(-120,0,ProfileStr($profile, 'LOCAL_ABROAD'),0,1, 'R');
$pdf->Ln(7); 
$pdf->SetFont('Arial','',12);    
$pdf->Cell(0,0,'Name of Company/Institution: ',0,1);
$pdf->Cell(-120,0,ProfileStr($profile, 'NAME_COMPANY'),0,1, 'R');
$pdf->Ln(7); 
$pdf->SetFont('Arial','',12);      
$pdf->Cell(0,0,'Address of the Company: ',0,1);
$pdf->Cell(-120,0,ProfileStr($profile, 'ADDRESS_COMPANY'),0,1, 'R');
$pdf->Ln(7); 
$pdf->SetFont('Arial','',12);     
$pdf->Cell(0,0,'Contact number of the company: ',0,1);
$pdf->Cell(-120,0,ProfileStr($profile, 'CONTACT_COMPANY'),0,1, 'R');
$pdf->Ln(7); 
$pdf->SetFont('Arial','',12);     
$pdf->Cell(0,0,'Position: ',0,1);
$pdf->Cell(-120,0,ProfileStr($profile, 'POSITION'),0,1, 'R');
$pdf->Ln(7); 
$pdf->SetFont('Arial','',12);      
$pdf->Cell(0,0,'Job Level(first job): ',0,1);
$pdf->Cell(-120,0,ProfileStr($profile, 'LEVEL_FIRST_JOB'),0,1, 'R');
$pdf->Ln(7); 
$pdf->SetFont('Arial','',12);      
...
$pdf->Cell(-120,0,ProfileStr($profile, 'AWARD_DOC'),0,1, 'R');

$pdf->Ln(7); 
$pdf->SetFont('Arial','',12);      
$pdf->Cell(0,0,'Level of award: ',0,1);
$pdf->Cell(-120,0,ProfileStr($profile, 'LEVEL_AWARD'),0,1, 'R');
