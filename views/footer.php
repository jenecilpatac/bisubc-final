            ...
            <!-- Footer -->
            <div class="container-fluid footer position-relative bg-warning text-white-50 mt-5 py-5 px-4 px-lg-5 wow fadeIn" data-wow-delay="0.1s">
        <div class="row g-5 py-5">
            <div class="col-lg-6 pe-lg-5">
                ...
                <p><i class="fa fa-phone-alt me-2"></i>+639 345 67890</p>
                <p><i class="fa fa-envelope me-2"></i>bisu_bc@ais.com</p>
    ...
    <div class="container-fluid bg-dark text-white border-top border-secondary px-0">
        <div class="d-flex flex-column flex-md-row justify-content-between">
            <div class="py-4 px-5 text-center text-md-start">
                <p class="mb-0">&copy; <a class="text-primary" href="index.php">BISU-BC AIS</a>. All Rights Reserved 2023.</p>
            </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a class="btn btn-warning" href="index.php?m=logout">Logout</a>
                </div>
            </div>
        </div>
    </div>
